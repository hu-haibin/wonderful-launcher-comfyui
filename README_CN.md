...
[**下载安装包**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.1) · [**更新说明**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.1) · [**官网**](https://wonderfullauncher.com/) · [**文档**](https://wonderfullauncher.com/docs) · [**反馈问题**](https://github.com/hu-haibin/wonderful-launcher-comfyui/issues)
...
- **普通用户推荐**：[Wonderful Launcher 2.1.1 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.1)
- **更新说明**：[Wonderful Launcher 2.1.1](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.1)
- **公开稳定回退版本**：[ModelFinder 2.0.31](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.31)

打开安装包 release，下载 `WonderfulLauncher-Setup-v2.1.1.exe`。
...
发布于 2026 年 7 月 6 日。[查看完整 GitHub Release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.1)。

这个版本是一个桌面端小更新，让标题栏语言切换和设置页保持一致。

- **标题栏可以直接选择语言**：点击语言按钮会打开菜单，不再需要连续点击循环切换。
- **语言选项保持一致**：跟随系统、繁体中文、英文、日文、韩文与设置页使用同一组选项。
- **切换反馈更明确**：切换语言后，标题栏短标签和当前选中状态会一起刷新。
- **补丁版打包**：桌面端版本信息和安装包资产更新到 2.1.1。
...
1. 打开 [安装包下载 release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.1)。
2. 下载 `WonderfulLauncher-Setup-v2.1.1.exe`。
...
- [Wonderful Launcher 2.1.1 更新说明](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.1)
- [Wonderful Launcher 2.1.1 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.1)
