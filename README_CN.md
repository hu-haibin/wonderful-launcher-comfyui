...
[**下载 2.1.9**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.9) · [**更新说明**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.9) · [**官网**](https://wonderfullauncher.com/) · [**文档**](https://wonderfullauncher.com/docs) · [**反馈问题**](https://github.com/hu-haibin/wonderful-launcher-comfyui/issues)
...
- **普通用户推荐**：[Wonderful Launcher 2.1.9 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.9)
- **安装包文件**：`WonderfulLauncher-Setup-v2.1.9.exe`
...
发布于 2026 年 7 月 12 日。[查看完整 GitHub Release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.9)。

这个版本把简体中文恢复为桌面端一等语言，同时继续保留繁体中文分支，并把 Agent 余额不足时的主按钮改为已验证的 starter 积分包。

- **简体中文桌面语言恢复**：Avalonia 桌面端现在同时支持简体中文（`zh-Hans`）和繁体中文（`zh-Hant`），语言标签、资源文件、Agent 提示和 ComfyUI WebView 语言路由都分开处理。
- **Agent starter 积分包入口**：Agent 因余额不足被挡住时，主按钮会直接打开 `starter` 积分包结账；Agent Access 仍保留为次级入口。
- **结账归因补齐**：桌面结账请求会带上 UI 语言和 ComfyUI 语言，后续商业事件可以区分简体中文和繁体中文用户。
- **发版验证**：v2.1.9 安装包来自 self-contained Avalonia release 路径，并用隔离 profile 做过发布根目录启动烟测。
- **桌面打包版本更新**：桌面端版本信息、安装包资产和校验文件更新到 2.1.9。
...
1. 打开 [2.1.9 安装包 release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.9)。
2. 下载 `WonderfulLauncher-Setup-v2.1.9.exe`。
...
- [Wonderful Launcher 2.1.9 更新说明](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.9)
- [Wonderful Launcher 2.1.9 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.9)
