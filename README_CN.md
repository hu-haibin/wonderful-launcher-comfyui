...
[**下载最新安装包**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/latest) · [**官网**](https://wonderfullauncher.com/) · [**文档**](https://wonderfullauncher.com/docs) · [**故障排查**](https://wonderfullauncher.com/troubleshooting) · [**2.0.27 更新说明**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.27) · [**全部 Releases**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases) · [**反馈问题**](https://github.com/hu-haibin/wonderful-launcher-comfyui/issues)
...
发布于 2026 年 6 月 16 日。[查看完整 GitHub Release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.27)。

这次更新把公开 Windows 桌面版切到 Avalonia shell，同时保留普通用户熟悉的 ModelFinder 安装包和自动升级路径。

- **WinUI 用户可直接升级到 Avalonia**：安装包继续使用稳定的 ModelFinder 身份、安装位置和文件名，用户不用区分 Avalonia / WinUI。
- **图片和积分流程更完整**：余额不足时使用应用内积分包卡片，生成控件更清楚，图片相关操作尽量留在桌面工作流里完成。
- **工作区修复更贴近现场**：缺节点、缺模型、插件导入失败和修复入口会更靠近当前 ComfyUI 工作区。
- **发版升级链已验证**：已用 2.0.26 WinUI 安装包 smoke 到 2.0.27 Avalonia 安装包，验证 pending installer 应用和升级后重新启动。
