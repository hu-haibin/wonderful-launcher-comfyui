...
[**下载最新安装包**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/latest) · [**2.0.16 更新说明**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.16) · [**2.0 系列归档**](#20-系列发布归档) · [**反馈问题**](https://github.com/hu-haibin/wonderful-launcher-comfyui/issues)
...
发布于 2026 年 5 月 23 日。[打开 2.0.16 GitHub Release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.16)。

这个版本重点提升 WinUI 启动、运行时恢复和 Agent 辅助修复的稳定性。

| 方向 | 变化 |
|------|------|
| **启动恢复** | AI 助手会拿到更清晰的启动失败证据，恢复提示不容易丢失真正的失败上下文。 |
| **运行时收敛** | 首页启动状态和 WebView 重启路径在启动、停止、重启后更稳定地回到正确状态。 |
| **插件修复** | 插件安装后的重启验证窗口更长，慢环境下不容易误判为超时失败。 |
| **包清理** | 批量卸载的体积统计更一致，并增加删除全部插件的清理动作。 |
| **在线图片工作区** | 新版 Image 页已完成真机 smoke，覆盖 R2 取图、图生图参考图、多图生成、重启恢复和不误删本地历史。 |
| **发版可靠性** | 公开安装包继续使用 self-contained WinUI 打包，并通过完整 Release 测试和隔离启动 smoke。 |

<p align="center">
  <img src="assets/screenshots/2.0.16-image-new-count4.png" alt="图片工作区显示四张生成结果" width="32%" />
  <img src="assets/screenshots/2.0.16-image-new-recovery.png" alt="重启后图片工作区恢复云端结果" width="32%" />
  <img src="assets/screenshots/2.0.16-image-new-close-guard.png" alt="图片工作区退出确认说明云端恢复" width="32%" />
</p>
