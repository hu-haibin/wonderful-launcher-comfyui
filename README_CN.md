...
[**下载 2.1.6**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.6) · [**更新说明**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.6) · [**官网**](https://wonderfullauncher.com/) · [**文档**](https://wonderfullauncher.com/docs) · [**反馈问题**](https://github.com/hu-haibin/wonderful-launcher-comfyui/issues)
...
- **普通用户推荐**：[Wonderful Launcher 2.1.6 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.6)
- **安装包文件**：`WonderfulLauncher-Setup-v2.1.6.exe`
...
发布于 2026 年 7 月 10 日。[查看完整 GitHub Release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.6)。

这个版本重点提高启动和运行诊断的可信度，尤其是 PyTorch、Python 或所选显卡后端导致 ComfyUI 无法启动时。

- **启动失败原因更清楚**：启动结果改用稳定错误码，不再把 PyTorch 或环境失败留成无法归类的错误。
- **运行后端归因更准确**：诊断会保留整合包后端和实际运行后端，便于区分 NVIDIA、AMD 与 CPU 情况。
- **减少重复错误噪声**：相同致命错误和界面无响应信号只在有意义的出现次数上报，不再连续刷同一条诊断。
- **诊断继续保护隐私**：启动器只上报结构化健康信息，不上传原始启动日志、提示词、工作流、模型内容、凭据或本地文件内容。
- **桌面打包版本更新**：桌面端版本信息、安装包资产和校验文件更新到 2.1.6。
...
1. 打开 [2.1.6 安装包 release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.6)。
2. 下载 `WonderfulLauncher-Setup-v2.1.6.exe`。
...
- [Wonderful Launcher 2.1.6 更新说明](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.6)
- [Wonderful Launcher 2.1.6 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.6)
