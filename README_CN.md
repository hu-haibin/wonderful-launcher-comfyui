...
- **普通用户推荐**：[Wonderful Launcher 2.0.45 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.45-repair-setup)
- **更新说明**：[Wonderful Launcher 2.0.45](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.45)
- **公开稳定回退版本**：[ModelFinder 2.0.31](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.31)

打开安装包 release，下载 `WonderfulLauncher-Setup-v2.0.45.exe`。
...
发布于 2026 年 6 月 24 日。[查看完整 GitHub Release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.45)。

这次更新重点治理 Agent 修复链路、Avalonia 启动与导入流程，以及旧品牌安装后的升级收敛。

- **Agent 修复证据更稳定**：长时间安装任务会返回仍在运行的任务终端会话，而不是被误判为失败；重启后仍可读取归档终端日志；ComfyUI 核心文件缺失时会停止无关的 pip 或 PyTorch 重试。
- **运行环境流程更稳**：导入或拖入已有 ComfyUI 文件夹时，会尊重当前正在运行的包；硬件探测不再阻塞主启动流程；ComfyUI 正常退出和异常退出的分类更清楚。
- **安装器清理更严格**：升级或修复安装时，会清理 `Wonderful Launcher` 开始菜单文件夹里遗留的 `ModelFinder` / `Uninstall ModelFinder` 快捷方式。
- **更新恢复指向当前安装包**：更新代理和修复下载路径已经准备好使用 2.0.45 安装器，并继续保持自包含 Windows 安装包形态。
...
1. 打开 [安装包下载 release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.45-repair-setup)。
2. 下载 `WonderfulLauncher-Setup-v2.0.45.exe`。
...
- [Wonderful Launcher 2.0.45 更新说明](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.45)
- [Wonderful Launcher 2.0.45 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.45-repair-setup)
