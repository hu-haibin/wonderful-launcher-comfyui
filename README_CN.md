...
[**下载最新安装包**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/latest) · [**官网**](https://wonderfullauncher.com/) · [**文档**](https://wonderfullauncher.com/docs) · [**故障排查**](https://wonderfullauncher.com/troubleshooting) · [**2.0.28 更新说明**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.28) · [**全部 Releases**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases) · [**反馈问题**](https://github.com/hu-haibin/wonderful-launcher-comfyui/issues)
...
发布于 2026 年 6 月 17 日。[查看完整 GitHub Release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.28)。

这次更新继续打磨新的 Avalonia 桌面版，让 AI 助手在 ComfyUI 诊断和修复时更稳、更少打扰。

- **AI 助手入口更清楚**：空状态只保留一个上下文诊断入口，不再放三个互相重叠的预设提示。
- **修复链更不容易漂移**：粘贴 ComfyUI 启动日志时，不会再沿用上一轮插件修复目标；正常启动日志也更不容易被误判成插件导入失败。
- **审批体验更轻**：修复权限在 AI 面板内处理，选项更接近“允许本会话 / 拒绝”，减少大弹窗打断。
- **工作区门禁更可信**：缺模型下载和模型查找会把未登录用户引导到登录，而不是显示容易误解的 0 个可下载。
