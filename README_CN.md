...
[**下载安装包**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.2) · [**更新说明**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.2) · [**官网**](https://wonderfullauncher.com/) · [**文档**](https://wonderfullauncher.com/docs) · [**反馈问题**](https://github.com/hu-haibin/wonderful-launcher-comfyui/issues)
...
- **普通用户推荐**：[Wonderful Launcher 2.1.2 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.2)
- **更新说明**：[Wonderful Launcher 2.1.2](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.2)
- **公开稳定回退版本**：[ModelFinder 2.0.31](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.31)

打开安装包 release，下载 `WonderfulLauncher-Setup-v2.1.2.exe`。
...
发布于 2026 年 7 月 6 日。[查看完整 GitHub Release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.2)。

这个版本是一个桌面端小更新，让标题栏语言菜单更清楚，只显示具体语言。

- **标题栏可以直接选择语言**：点击语言按钮会打开菜单，不再需要连续点击循环切换。
- **标题栏不再显示容易误解的系统选项**：跟随系统保留在设置页，标题栏快捷菜单只显示繁体中文、英文、日文、韩文。
- **当前选中状态更清楚**：如果设置页选择了跟随系统，标题栏菜单会标记实际解析出来的语言。
- **补丁版打包**：桌面端版本信息和安装包资产更新到 2.1.2。
...
1. 打开 [安装包下载 release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.2)。
2. 下载 `WonderfulLauncher-Setup-v2.1.2.exe`。
...
- [Wonderful Launcher 2.1.2 更新说明](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.2)
- [Wonderful Launcher 2.1.2 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.2)
