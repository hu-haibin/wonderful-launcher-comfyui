...
- **普通用户推荐**：[Wonderful Launcher 2.0.44 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.44-repair-setup)
- **更新说明**：[Wonderful Launcher 2.0.44](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.44)
- **公开稳定回退版本**：[ModelFinder 2.0.31](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.31)

打开安装包 release，下载 `WonderfulLauncher-Setup-v2.0.44.exe`。
...
发布于 2026 年 6 月 22 日。[查看完整 GitHub Release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.44)。

这次更新优化了 WebView 工作区里的缺失模型修复体验，同时继续保留修复安装包路径。

- **缺失模型下载完成后自动刷新工作区**：模型下载完成后，内置 ComfyUI 页面会自动刷新模型选项并清掉旧的红色节点错误，不需要用户手动刷新网页。
- **拖入模型和启动器下载走同一条修复逻辑**：自己拖入归纳的模型、以及启动器下载完成的缺失模型，都会更新当前工作流状态。
- **修复安装包仍然可用**：旧版本如果无法完成应用内升级，仍然可以下载并运行最新 Setup 安装包。
- **不需要额外安装桌面运行时**：正常用户直接运行 Windows 安装包即可。
...
1. 打开 [安装包下载 release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.44-repair-setup)。
2. 下载 `WonderfulLauncher-Setup-v2.0.44.exe`。
...
- [Wonderful Launcher 2.0.44 更新说明](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.44)
- [Wonderful Launcher 2.0.44 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.44-repair-setup)
