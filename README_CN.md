...
[**下载 2.1.8**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.8) · [**更新说明**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.8) · [**官网**](https://wonderfullauncher.com/) · [**文档**](https://wonderfullauncher.com/docs) · [**反馈问题**](https://github.com/hu-haibin/wonderful-launcher-comfyui/issues)
...
- **普通用户推荐**：[Wonderful Launcher 2.1.8 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.8)
- **安装包文件**：`WonderfulLauncher-Setup-v2.1.8.exe`
...
发布于 2026 年 7 月 12 日。[查看完整 GitHub Release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.8)。

这个版本重点提升工作流缺失节点修复的可靠性，也让内置休闲小游戏更容易操作。

- **一次点击继续修复**：缺失节点修复若先需要 ComfyUI-Manager，启动器会安装它、重启 ComfyUI，并在工作区就绪后继续原来的修复请求。
- **插件选择更稳**：工作流携带的 `cnr_id`、`aux_id` 元数据会优先于有歧义的目录别名，减少装错插件的建议，并过滤已知不安全候选。
- **只收集有限的修复证据**：遥测记录修复选择和同一工作流的复检结果，不上传工作流文件原文；这样才能把反复出现的节点问题排进后续修复优先级。
- **内置本地小游戏优化**：可选的离线小游戏明确显示方向键/A-D 操作，支持游戏内切换语言和重新开始；若内置脚本出错，也会留下诊断日志。
- **桌面打包版本更新**：桌面端版本信息、安装包资产和校验文件更新到 2.1.8。
...
1. 打开 [2.1.8 安装包 release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.8)。
2. 下载 `WonderfulLauncher-Setup-v2.1.8.exe`。
...
- [Wonderful Launcher 2.1.8 更新说明](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.8)
- [Wonderful Launcher 2.1.8 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.8)
