...
[**下载安装包**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/latest) · [**更新说明**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.41) · [**官网**](https://wonderfullauncher.com/) · [**文档**](https://wonderfullauncher.com/docs) · [**反馈问题**](https://github.com/hu-haibin/wonderful-launcher-comfyui/issues)
...
- **普通用户推荐**：[Wonderful Launcher 2.0.41](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.41)
- **稳定回退版本**：[ModelFinder 2.0.31](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.31)

请在 release 资产里下载 `WonderfulLauncher-Setup-v*.exe`。

如果较早的 2.0.x 版本提示更新已下载，但重启更新失败，请手动下载最新版安装包并覆盖安装一次。2.0.41 会修复更新交接流程，保留你的数据，并清理旧启动入口。
> [!WARNING]
...
> [!IMPORTANT]
> 如果 2.0.37、2.0.38 或很旧的 1.5.x 版本已经下载更新，但重启后仍无法真正升级，请直接下载本页最新 **Setup 安装包** 并运行。完整安装包是受影响旧客户端的官方恢复路径，会保留启动器数据，把旧 `ModelFinder` 配置数据迁移到当前 Wonderful Launcher 配置目录，并修复后续版本的更新接力。你不需要先手动删除旧的 `ModelFinder` 目录。
...
发布于 2026 年 6 月 22 日。[查看完整 GitHub Release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.41)。

这次更新补齐了安装版客户端的“修复并升级”路径。

- **修复并升级界面**：检测到更新链损坏时，不再反复进入重启更新循环，而是引导运行修复安装器。
- **客户端感知的更新 feed**：已知坏版本会进入修复安装器或手动下载通道，正常版本继续走普通自动更新。
- **安装器收敛旧品牌入口**：完整安装包会修复旧启动入口，并向 Wonderful Launcher 品牌路径收敛，同时不删除用户数据根目录。
- **更稳的更新交接和迁移**：更新参数、已下载安装包恢复、旧数据迁移都有针对性回归测试覆盖。
...
- [Wonderful Launcher 2.0.41 更新说明](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.41)
