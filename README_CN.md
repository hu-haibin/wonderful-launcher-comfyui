...
[**下载安装包**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.0) · [**更新说明**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.0) · [**官网**](https://wonderfullauncher.com/) · [**文档**](https://wonderfullauncher.com/docs) · [**反馈问题**](https://github.com/hu-haibin/wonderful-launcher-comfyui/issues)
...
- **普通用户推荐**：[Wonderful Launcher 2.1.0 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.0)
- **更新说明**：[Wonderful Launcher 2.1.0](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.0)
- **公开稳定回退版本**：[ModelFinder 2.0.31](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.31)

打开安装包 release，下载 `WonderfulLauncher-Setup-v2.1.0.exe`。
...
发布于 2026 年 6 月 30 日。[查看完整 GitHub Release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.0)。

这个版本收窄 AI 入口，把确定性的启动修复重新交回启动器自身完成。

- **启动失败修复变成确定性流程**：当启动失败指向 core requirements 或 PyTorch 时，启动器会打开任务终端，执行用户确认过的修复，安装兼容 PyTorch，并尝试重启验证。
- **Agent 不再接管启动失败修复**：启动失败和环境安装失败停留在启动器原生链路，不再跳到 AI 抽屉里用对话方式修复。
- **任务终端反馈更清楚**：安装、卸载任务启动时会有可见进度状态，批量卸载也减少了额外 pip version check 开销。
- **Agent 边界更明确**：内置 Agent 入口收窄，后续高级 AI 修复更适合做成扩展/插件能力，而不是核心启动路径依赖。
...
1. 打开 [安装包下载 release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.0)。
2. 下载 `WonderfulLauncher-Setup-v2.1.0.exe`。
...
- [Wonderful Launcher 2.1.0 更新说明](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.0)
- [Wonderful Launcher 2.1.0 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.0)
