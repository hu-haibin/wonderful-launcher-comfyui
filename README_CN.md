...
[**下载安装包**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/latest) · [**更新说明**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.39) · [**官网**](https://wonderfullauncher.com/) · [**文档**](https://wonderfullauncher.com/docs) · [**反馈问题**](https://github.com/hu-haibin/wonderful-launcher-comfyui/issues)
...
- **普通用户推荐**：[Wonderful Launcher 2.0.39](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.39)
...
如果较早的 2.0.x 版本提示更新已下载，但重启更新失败，请手动下载最新版安装包并覆盖安装一次。这样会修复后续版本的更新交接流程。
...
- [Wonderful Launcher 2.0.39 更新说明](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.39)
