...
[**下载安装包**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.4) · [**更新说明**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.4) · [**官网**](https://wonderfullauncher.com/) · [**文档**](https://wonderfullauncher.com/docs) · [**反馈问题**](https://github.com/hu-haibin/wonderful-launcher-comfyui/issues)
...
- **普通用户推荐**：[Wonderful Launcher 2.1.4 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.4)
- **更新说明**：[Wonderful Launcher 2.1.4](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.4)

打开安装包 release，下载 `WonderfulLauncher-Setup-v2.1.4.exe`。
...
发布于 2026 年 7 月 8 日。[查看完整 GitHub Release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.4)。

这个版本改善了工作流缺失模型处理，尤其是引用 Hugging Face 登录墙模型页面时的行为。

- **补齐 FLUX Kontext 模型目录**：`flux1-kontext-dev.safetensors` 已改用审核过的公开下载源，不再指向需要授权的官方仓库。
- **联网 fallback 更安全**：Hugging Face 搜到需要登录或申请权限的候选时，会拒绝作为可下载链接展示。
- **缺失模型遥测更清楚**：被拒绝的 fallback 候选会关联回原始云端目录查询，后续更容易补 catalog。
- **补丁版打包**：桌面端版本信息和安装包资产更新到 2.1.4。
...
1. 打开 [安装包下载 release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.4)。
2. 下载 `WonderfulLauncher-Setup-v2.1.4.exe`。
...
- [Wonderful Launcher 2.1.4 更新说明](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.4)
- [Wonderful Launcher 2.1.4 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.4)
