...
[**下载 2.1.5**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.5) · [**更新说明**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.5) · [**官网**](https://wonderfullauncher.com/) · [**文档**](https://wonderfullauncher.com/docs) · [**反馈问题**](https://github.com/hu-haibin/wonderful-launcher-comfyui/issues)
...
- **普通用户推荐**：[Wonderful Launcher 2.1.5 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.5)
- **安装包文件**：`WonderfulLauncher-Setup-v2.1.5.exe`
...
发布于 2026 年 7 月 8 日。[查看完整 GitHub Release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.5)。

这个版本重点处理图片工作区的参考图流程：去掉容易误导用户的失败通知，并让参考图缩略图清楚展示“正在准备中”的状态。

- **不再弹出嘈杂的添加参考图通知**：添加参考图时，不会在图片尚未真正准备好之前弹出成功或失败通知。
- **准备中状态更清楚**：参考图缩略图会先变暗，并在中央显示圆形 `0%` 指示，不再用不明显的小角标或横向进度条。
- **生成前使用已就绪参考图快照**：提交生成时会先整理 ready reference snapshot，避免内部 pending bytes 以 `Reference bytes are not ready` 这种错误暴露给用户。
- **当前参考图可预览**：在编辑器里双击有本地路径的当前参考图缩略图，可以打开图片查看器。
- **桌面打包版本更新**：桌面端版本信息、安装包资产和校验文件更新到 2.1.5。
...
1. 打开 [2.1.5 安装包 release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.5)。
2. 下载 `WonderfulLauncher-Setup-v2.1.5.exe`。
...
- [Wonderful Launcher 2.1.5 更新说明](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.5)
- [Wonderful Launcher 2.1.5 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.5)
