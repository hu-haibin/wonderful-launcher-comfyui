...
[**下载 2.1.10**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.10) · [**更新说明**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.10) · [**官网**](https://wonderfullauncher.com/) · [**文档**](https://wonderfullauncher.com/docs) · [**反馈问题**](https://github.com/hu-haibin/wonderful-launcher-comfyui/issues)
...
- **普通用户推荐**：[Wonderful Launcher 2.1.10 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.10)
- **安装包文件**：`WonderfulLauncher-Setup-v2.1.10.exe`
...
发布于 2026 年 7 月 15 日。[查看完整 GitHub Release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.10)。

这个版本完成了单 Avalonia 桌面端的收敛，并让左下角的账户和充值路径更容易找到、也能被正确衡量。

- **账户与充值入口**：左下角账户菜单会持续显示“充值”。登录后可看到当前积分和可选积分包；未登录时会先进入正常的账号登录流程。
- **结账归因补齐**：账户菜单浏览、从充值入口完成登录、选择积分包和打开结账，都会归因到这个入口；单纯的登录尝试不会被当作购买。
- **单一桌面端主线**：实际发布的客户端只保留 Avalonia；WinUI 只保留为历史源码记录，不再是第二条产品或发布路径。
- **Photoshop 插件延续**：UXP 插件继续随 Avalonia 应用发布，运行时路径为 `Assets/photoshop-plugin`。
- **发版验证**：self-contained v2.1.10 包已通过完整 Release 测试、隔离的更新准备 smoke 和发布根目录启动 smoke。
...
1. 打开 [2.1.10 安装包 release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.10)。
2. 下载 `WonderfulLauncher-Setup-v2.1.10.exe`。
...
- [Wonderful Launcher 2.1.10 更新说明](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.10)
- [Wonderful Launcher 2.1.10 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.1.10)
