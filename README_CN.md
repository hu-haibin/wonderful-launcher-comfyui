...
[**下载安装包**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/latest) · [**更新说明**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.40) · [**官网**](https://wonderfullauncher.com/) · [**文档**](https://wonderfullauncher.com/docs) · [**反馈问题**](https://github.com/hu-haibin/wonderful-launcher-comfyui/issues)
...
- **普通用户推荐**：[Wonderful Launcher 2.0.40](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.40)
...
发布于 2026 年 6 月 22 日。[查看完整 GitHub Release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.40)。

这次更新主要用于修复安装版客户端的更新接力和旧品牌数据迁移问题。

- **旧版安装器恢复路径**：最新完整安装包可以修复无法完成重启更新接力的旧安装版。
- **更新接力更稳**：修正 Windows 安装路径包含空格或结尾反斜杠时，更新 helper 参数被错误解析的问题。
- **旧品牌数据迁移**：首次启动新版时，会把旧 `ModelFinder` 配置数据迁移到 `Wonderful Launcher`，并保留旧目录作为备份。
- **避免粗暴复制缓存**：`WebView2` 等体积较大的浏览器/运行时缓存不会被静默批量复制。
...
- [Wonderful Launcher 2.0.40 更新说明](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.40)
