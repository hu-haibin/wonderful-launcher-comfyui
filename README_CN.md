...
[**下载安装包**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.48) · [**更新说明**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.48) · [**官网**](https://wonderfullauncher.com/) · [**文档**](https://wonderfullauncher.com/docs) · [**反馈问题**](https://github.com/hu-haibin/wonderful-launcher-comfyui/issues)
...
- **普通用户推荐**：[Wonderful Launcher 2.0.48 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.48)
- **更新说明**：[Wonderful Launcher 2.0.48](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.48)
- **公开稳定回退版本**：[ModelFinder 2.0.31](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.31)

打开安装包 release，下载 `WonderfulLauncher-Setup-v2.0.48.exe`。
...
发布于 2026 年 6 月 27 日。[查看完整 GitHub Release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.48)。

这次更新重点让桌面端 Agent 适配当前网站协议，并让 ComfyUI 修复动作更安全、更容易验证。

- **Agent 工具闭环更稳**：桌面端会向网站 Agent 路由保留更完整的工具和结果状态，减少纯文本降级以及“看起来修好了但其实没闭环”的情况。
- **缺失节点安装更安全**：会阻止 ComfyUI-Manager 里的宽泛匹配规则自动安装无关插件，避免把辅助类插件误当成工作流缺失节点修复。
- **插件依赖修复保护运行时**：插件 requirements 里可能拉动 `xformers`、torch 系列包或原生加速器时，会走约束和保护逻辑，而不是静默改坏当前 ComfyUI 运行时。
- **工作流导入和日志可读性改进**：API prompt JSON 会优先交给 ComfyUI 前端转换；启动日志保留真正的 warning/error 颜色，同时减少 WebView 和 UI bounds 的刷屏日志。
...
1. 打开 [安装包下载 release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.48)。
2. 下载 `WonderfulLauncher-Setup-v2.0.48.exe`。
...
- [Wonderful Launcher 2.0.48 更新说明](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.48)
- [Wonderful Launcher 2.0.48 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.48)
