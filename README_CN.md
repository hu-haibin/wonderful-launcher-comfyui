...
[**下载安装包**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.49) · [**更新说明**](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.49) · [**官网**](https://wonderfullauncher.com/) · [**文档**](https://wonderfullauncher.com/docs) · [**反馈问题**](https://github.com/hu-haibin/wonderful-launcher-comfyui/issues)
...
- **普通用户推荐**：[Wonderful Launcher 2.0.49 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.49)
- **更新说明**：[Wonderful Launcher 2.0.49](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.49)
- **公开稳定回退版本**：[ModelFinder 2.0.31](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.31)

打开安装包 release，下载 `WonderfulLauncher-Setup-v2.0.49.exe`。
...
发布于 2026 年 6 月 28 日。[查看完整 GitHub Release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.49)。

这是一次热修复，让桌面端登录和 Agent 修复流程继续匹配当前 Wonderful Launcher 网站。

- **桌面登录会携带应用版本**：网站可以对过旧桌面客户端显示明确的英文升级页面，而不是让不兼容版本继续进入异常登录流程。
- **启动修复完成态更严格**：ComfyUI 已验证进入 Ready 后，Agent 不会再把最终总结里提到的 restart/start/core-repair 工具名当成下一步继续自动执行。
- **发布门禁补强**：2.0.49 安装包在打包前通过了完整 Release 测试，包括 Agent 启动修复和启动器数据迁移回归。
- **Agent Access 次数口径受控**：这个桌面版本配合网站侧免费次数重置修复，免费用户继续按免费上限计数，付费 Agent Access 授权保持不受影响。
...
1. 打开 [安装包下载 release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.49)。
2. 下载 `WonderfulLauncher-Setup-v2.0.49.exe`。
...
- [Wonderful Launcher 2.0.49 更新说明](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.49)
- [Wonderful Launcher 2.0.49 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.49)
