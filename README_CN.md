...
- **普通用户推荐**：[Wonderful Launcher 2.0.43 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.43-repair-setup)
- **更新说明**：[Wonderful Launcher 2.0.43](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.43)
- **公开稳定回退版本**：[ModelFinder 2.0.31](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.31)

打开安装包 release，下载 `WonderfulLauncher-Setup-v2.0.43.exe`。
...
发布于 2026 年 6 月 22 日。[查看完整 GitHub Release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.43)。

这次更新继续保留修复安装包路径，并提升对已有 ComfyUI 目录的兼容性。

- **旧版升级卡住时，运行最新安装包**：旧版本如果无法完成应用内升级，修复安装包仍然是推荐路径。
- **只保留新的产品目录**：安装器会把 Wonderful Launcher 收敛到 `%LOCALAPPDATA%\WonderfulLauncher`。
- **导入已有 ComfyUI 更稳**：能更可靠识别 Python 放在 `ComfyUI\python\python.exe` 的目录结构。
...
1. 打开 [安装包下载 release](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.43-repair-setup)。
2. 下载 `WonderfulLauncher-Setup-v2.0.43.exe`。
...
- [Wonderful Launcher 2.0.43 更新说明](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.43)
- [Wonderful Launcher 2.0.43 Setup 安装包](https://github.com/hu-haibin/wonderful-launcher-comfyui/releases/tag/v2.0.43-repair-setup)
